...
TEST_F(PreProcessorTest, TestDefinitionWithParameters) {
    std::string src = "# test _foo_ bar";
    std::string expected = "# test _foo_ bar\n";

    testDefinition(src, expected);
}

TEST_F(PreProcessorTest, TestDefinitionWithMultipleParameters) {
    std::string src = "# _other param_ test _foo_ bar";
    std::string expected = "# _other param_ test _foo_ bar\n";
